...
const start = async () => {
	try {
		await connectDB('mongodb+srv://thang:thang@cluster0.cmnpncg.mongodb.net/?retryWrites=true&w=majority');
		server.listen(PORT, () => console.log(`DB connected and server running on port ${PORT}`));
	} catch (error) {
		console.log(error);
	}
};
